...
static bool parse_str(const char *str, ParseTable *table, Expr **out_tree)
{
    ...
    for (;str[index] != '\0'; ++index)
    {
        ...
        else if (str[index] == 'c') token_list[token_count++] = {TOKEN_c, &str[index], 1, 1};
        else if (str[index] == 'd') token_list[token_count++] = {TOKEN_d, &str[index], 1, 1};
        else if (str[index] == 'e') token_list[token_count++] = {TOKEN_e, &str[index], 1, 1};
        else if (str[index] == 'f') token_list[token_count++] = {TOKEN_f, &str[index], 1, 1};
        else if (str[index] == 'g') token_list[token_count++] = {TOKEN_g, &str[index], 1, 1};
        else if (str[index] == 'h') token_list[token_count++] = {TOKEN_h, &str[index], 1, 1};
        else if (str[index] == 'i') token_list[token_count++] = {TOKEN_i, &str[index], 1, 1};
        else if (str[index] == 'j') token_list[token_count++] = {TOKEN_j, &str[index], 1, 1};
        else if (str[index] == 'k') token_list[token_count++] = {TOKEN_k, &str[index], 1, 1};
        else if (str[index] == 'l') token_list[token_count++] = {TOKEN_l, &str[index], 1, 1};
        else if (str[index] == 'm') token_list[token_count++] = {TOKEN_m, &str[index], 1, 1};
        else if (str[index] == 'n') token_list[token_count++] = {TOKEN_n, &str[index], 1, 1};
        else if (str[index] == 'o') token_list[token_count++] = {TOKEN_o, &str[index], 1, 1};
        else if (str[index] == 'p') token_list[token_count++] = {TOKEN_p, &str[index], 1, 1};
        else if (str[index] == 'q') token_list[token_count++] = {TOKEN_q, &str[index], 1, 1};
        else if (str[index] == 'r') token_list[token_count++] = {TOKEN_r, &str[index], 1, 1};
        else if (str[index] == 's') token_list[token_count++] = {TOKEN_s, &str[index], 1, 1};
        else if (str[index] == 't') token_list[token_count++] = {TOKEN_t, &str[index], 1, 1};
        else if (str[index] == 'u') token_list[token_count++] = {TOKEN_u, &str[index], 1, 1};
        else if (str[index] == 'v') token_list[token_count++] = {TOKEN_v, &str[index], 1, 1};
        else if (str[index] == 'w') token_list[token_count++] = {TOKEN_w, &str[index], 1, 1};
        else if (str[index] == 'x') token_list[token_count++] = {TOKEN_x, &str[index], 1, 1};
        else if (str[index] == 'y') token_list[token_count++] = {TOKEN_y, &str[index], 1, 1};
        else if (str[index] == 'z') token_list[token_count++] = {TOKEN_z, &str[index], 1, 1};
